...
impl Server {
    ...
    pub fn set_password_protected(&self, protected: bool) {
        unsafe {
            sys::SteamAPI_ISteamGameServer_SetPasswordProtected(self.server, protected);
        }
    }

    pub fn set_bot_player_count(&self, bot: i32) {
        unsafe {
            sys::SteamAPI_ISteamGameServer_SetBotPlayerCount(self.server, bot);
        }
    }

    pub fn secure(&self) -> bool {
        unsafe { sys::SteamAPI_ISteamGameServer_BSecure(self.server) }
    }
